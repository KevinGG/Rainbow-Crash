...
-(void)TwitterPost{
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeTwitter])
    {
        ...
        [tweetSheet setInitialText:@"I'm playing #RainbowCrash ! It's insanely fun! Download it from here: "];
...
-(void)TwitterPost:(int)score{
    ...
    {
        SLComposeViewController *tweetSheet = [SLComposeViewController composeViewControllerForServiceType:SLServiceTypeTwitter];
        [tweetSheet setInitialText:[@"I'm playing #RainbowCrash ! It's insanely fun! My score is: " stringByAppendingString:[NSString stringWithFormat:@"%d Download it from here: ",score]]];
        [tweetSheet addURL:[NSURL URLWithString:@"https://itunes.apple.com/us/app/rainbow-crash/id903688862?ls=1&mt=8"]];
        [tweetSheet addImage:[self getScreenShot]];
        [self.viewController presentViewController:tweetSheet animated:YES completion:nil];
    }
...
-(void)FacebookPost{
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeFacebook])
    {
        ...
        [facebooksheet setInitialText:@"I'm playing #RainbowCrash ! It's insanely fun! Download it from here: "];
...
-(void)FacebookPost:(int)score{
    ...
    {
        SLComposeViewController *facebooksheet = [SLComposeViewController composeViewControllerForServiceType:SLServiceTypeFacebook];
        [facebooksheet setInitialText:[@"I'm playing #RainbowCrash ! It's insanely fun! My score is: " stringByAppendingString:[NSString stringWithFormat:@"%d Download it from here: ",score]]];
        [facebooksheet addURL:[NSURL URLWithString:@"https://itunes.apple.com/us/app/rainbow-crash/id903688862?ls=1&mt=8"]];
        [facebooksheet addImage:[self getScreenShot]];
        [self.viewController presentViewController:facebooksheet animated:YES completion:nil];
    }
